...
func NewSocketListener(path string, m ManagerInterface) (*SocketListener, error) {
	_ = os.Remove(path)
...
func (sl *SocketListener) serve(m ManagerInterface) {
	defer sl.wg.Done()
...
func StartSocketListener(path string, m ManagerInterface) (*SocketListener, error) {
